...
public class Parser {
  ...
  Expr bool() throws IOException {
    ...
    while(look.tag == Tag.OR){
      Token t = look; move(); x = new Or(t, x, join());
    }
    return x;    
  }
  Expr join() throws IOException {
    ...
    while(look.tag == Tag.AND){
      Token t = look; move(); x = new And(t, x, equality());
    }
    return x;
  }
  Expr equality() throws IOException {
    ...
    while(look.tag == Tag.EQ || look.tag == Tag.NE){
      Token t = look; move(); x = new Rel(t, x, rel());
    }
    return x;    
  }
  Expr rel() throws IOException {
    ...
    switch(look.tag){
      case '<': case Tag.LE: case Tag.GE: case '>':
        Token t = look; move(); return new Rel(t, x, expr());
      default:
        return x;      
    }
  }
  Expr expr() throws IOException {
    ...
    while(look.tag == '+' || look.tag == '-'){
      Token t = look; move(); x = new Arith(t, x, term());
    }
    return x;
  }
  Expr term() throws IOException {
    Expr x = unary();
    while(look.tag == '*' || look.tag == '/'){
      Token t = look; move(); x = new Arith(t, x, unary());
    }
    return x;
  }
  Expr unary() throws IOException {
    if(look.tag == '-'){
      ...
      Token t = look; move(); return new Not(t, unary());
    }
    else return factor();    
  }
