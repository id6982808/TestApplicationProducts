...
inline void dd_zeros(double *x)
{
	x[0]=0.0;
	x[1]=0.0;
}

inline void td_zeros(double *x)
{
	x[0]=0.0;
	x[1]=0.0;
	x[2]=0.0;
...
inline void td_renorm4(double *c0, double *c1, double *c2, double *c3)
{
    double s0, s1, s2 = 0.0, s3 = 0.0;
...
inline void qd_renorm4(double *c0, double *c1, double *c2, double *c3)
{
    double s0, s1, s2 = 0.0, s3 = 0.0;
...
inline void qd_renorm5(double *c0, double *c1, double *c2, double *c3, double *c4)
{
    double s0, s1, s2 = 0.0, s3 = 0.0;
